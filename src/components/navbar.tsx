...
const Navbar = () => (
  ...
  <header className="text-gray-600 body-font shadow-lg">
    <div className="container flex flex-wrap p-2 flex-col md:flex-row items-left sm:items-center">
      <span className="flex-1 text-2xl text-black font-semibold sm:text-center sm:pl-7">Toobas_Dynamic_Blog</span>
      ...
      <div>
        <button className="w-36 px-6 items-center inline-flex bg-blue-700 border-0 py-3 focus:outline-none hover:bg-blue-500 rounded text-white mt-4 md:mt-0 sm:pl-7 lg:ml-32 lg:px-3 lg:py-1">
          LinkedIn
          <svg
            fill="none"
            stroke="currentColor"
