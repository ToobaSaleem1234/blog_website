...
const Authorcard = () => {
  return (
    <div className='bg-white shadow-lg rounded-lg px-4 py-6 mt-12'>
      ...
      <p className='mt-4 text-black leading-relaxed text-justify'>
        Hi, I am <span className='font-semibold'>Tooba Saleem</span>, a student of GIAIC and a future passionate developor with 2 years of experience in IT.My exprties lies in HTML,Custom CSS,Tailwind CSS,Typescript UI/UX Design for web Development.
      </p>
      <p className='mt-4 text-black leading-relaxed text-justify'>
